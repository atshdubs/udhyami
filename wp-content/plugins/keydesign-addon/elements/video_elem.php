...
if (!class_exists('KD_ELEM_VIDEO')) {
    class KD_ELEM_VIDEO extends KEYDESIGN_ADDON_CLASS {
        ...
        public function kd_video_shrt($atts, $content = null)
        {
            ...
            $embed = $video_w = $video_h = $kd_videomodal_id = '';
            ...
            $video_image_src = $default_src = $img = '';
            ...
            $kd_videomodal_id .= 'kd-videomodal-'.uniqid();

            $output = '<div class="video-container '.$video_extra_class.'">
                        '.$video_image_src.'
                        <a data-toggle="modal" data-target="#video-modal-'.$kd_videomodal_id.'" data-backdrop="true">
                        ...
                        <div class="modal fade video-modal" id="video-modal-'.$kd_videomodal_id.'" role="dialog">
