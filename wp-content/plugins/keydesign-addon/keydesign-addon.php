...
if (!class_exists('KEYDESIGN_ADDON_CLASS')) {
	...
	function show_vc_version_notice() {
		echo '
		<div class="updated">
			<p><strong>KeyDesign Addon</strong> requires <strong><a href="http://bit.ly/vcomposer" target="_blank">WPBakery Page Builder</a> version 5.4</strong> to be installed and activated on your site.</p>
		</div>';
	}
